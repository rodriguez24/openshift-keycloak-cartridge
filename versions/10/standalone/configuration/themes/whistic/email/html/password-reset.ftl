...
<head>
  <title>${msg("password.reset.title")}</title>
            ...
            <table cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td style="padding: 0 0 20px;">
                  <h2 style="color: #00bad6; font-weight: bold">${msg("password.reset.greeting", user.firstName)}</h2>
                </td>
              </tr>
              <tr>
                <td style="padding: 0 0 20px;">
                  <span>${msg("password.reset.text1")}</span>
                  <span style="color: #00bad6; font-weight: bold;">${msg("password.reset.text2")}</span>
                  <span>${msg("password.reset.text3")}</span>
                  <span style="color: #00bad6; font-weight: bold;">${msg("password.reset.text4", realmName)}</span>
                  <span>${msg("password.reset.text5")}</span>
                </td>
              </tr>
              <tr>
                <td style="padding: 0 0 20px; text-align: center;">
                  <a href="${msg("password.reset.link", link)}"
                    ...
                    ${msg("password.reset.button.text")}
                  </a>
                  <p style="text-align: left; margin-top: 20px;">${msg("password.reset.text6", linkExpiration)}</p>
                </td>
              </tr>
            </table>
          </td>
